...
export const caterers: Caterer[] = [
  {
    ...
    price: { starting: 1500 },
    rating: 4.8,
    description: 'Royal Feast Catering offers Pakistani and BBQ cuisine, with live cooking stations and a variety of desserts.',
  ...
  },
  {
    ...
    price: { starting: 1200 },
    rating: 4.5,
    description: 'Elegant Events Caterers specializes in continental cuisine and offers a premium buffet experience.',
  ...
  },
  {
    ...
    price: { starting: 1400 },
    rating: 4.7,
    description: 'Flavors by Sana brings Chinese and fusion cuisine to your events, with a focus on creative desserts.',
    amenities: ['Chinese Cuisine', 'Fusion Cuisine', 'Dessert Bar', 'Event Staff'],
    isSponsored: true,
  },
  {
    id: '4',
    ...
    price: { starting: 1300 },
    rating: 4.6,
    description: 'Mehfil Caterers offers authentic Pakistani cuisine and a variety of buffet options for weddings.',
